        ...
        >
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="p-6 rounded-xl border border-white/20 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] transition">
                        <h3 className="text-xl font-bold mb-2">Lexical & Syntax Analyzer</h3>
                        <p className="text-gray-400 mb-4">
                            Developed a C++ system that can read and analyze a 
                            new programming language by using lexical 
                            and syntax analyzer techniques
                        </p>
                        <div className="flex flex-wrap gap-2 mb-4">
                            {["C++"].map((tech, key) => (
                                <span 
                        ...
                        <div className="flex justify-between items-center">
                            <a 
                                href="https://github.com/smil7/lexical-syntax-analyzer"
                                className="text-blue-400 hover:text-blue-300 transition-colors my-4"    
                            > 
                                {" "}
                                View Project {"->"} 
